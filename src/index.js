...
function generaterecipe (event) {
    ...
    let context= `Generate a simple recipe with ingrident of instruction. Your mission is make a recipe in basic html, Separate the line with </br>. Make maxim 10 lines.  And dont show the  symbol  html in page. I want only all  letters of answer in black color,especially the title of recipe in black color. Follow the instructions.`;
